...
{
  wp_register_style('papertheme_style', get_template_directory_uri() . '/dist/css/PaperTheme.css', array(),'1.2.2', all);
  wp_register_style('papertheme_font', 'https://fonts.googleapis.com/css?family=Open+Sans:400,700', array(),'1.2.2', all);
